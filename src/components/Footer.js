...
class Footer extends Component {    
    render() {
        ...
        const elementInstagram = <FontAwesomeIcon icon={['fab', 'instagram']} /* size="1x" */ className="instagram"/>
        return (
            <footer id="footer">
                    ...
                    <div className="row">
                        <div className="col-sm footer-block">
                            <div className="form-contact">
                                ...
                                <form action="mail.php" method="POST" className="form-contact__form-content">
                ...
                <Link to="#home" class="button-up">
                    <i class="fas fa-chevron-circle-up fa-3x"></i>	      
                </Link>				
        
                <div class="footer-bottom">			
                    <div class="footer-bottom__footer-copyright">Up-and-Down &#169; 2020</div>	
                </div>
            </footer>	
